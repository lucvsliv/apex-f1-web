...
export default function Cart() {
    ...
    const currentTab = pathname.split("/").pop() || "cart";
                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-card border-cart-border rounded-lg border border-stone-200 p-6">
                                <h1 className="mb-6 text-2xl font-semibold">Shopping Cart</h1>

                                {/* Table Header - Hidden on mobile */}
                                <div className="border-cart-border text-muted-foreground mb-4 hidden gap-4 border-b border-stone-200 pb-4 text-sm font-medium lg:grid lg:grid-cols-[2fr,1fr,1fr,auto]">
                                    <div>Product</div>
